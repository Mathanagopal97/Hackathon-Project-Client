...
public class EventServlet extends HttpServlet {
     ...
     */
           ...
           String[] eventTitle = new String[10];
           String[] eventDescription = new String[30];
           String[] submittedby = new String[10];
           String[] eventLink = new String[30];
           Date[] eventDate = new Date[10];
    ...
    {
        //For count
        String sql = "SELECT COUNT(*) AS COUNT FROM event_table";
        ...
        while(rs.next())
        {
         ...
         eventTitle= new String[count];
        eventDescription = new String[count];
        //submittedby = new String[count];
        eventLink = new String[count];
        eventDate=new Date[count];
        ...
        while(rs.next())
        {
            eventTitle[i]=rs.getString(2);
            eventDescription[i] = rs.getString(3);
            //submittedby[i] = rs.getString(4);
            eventLink[i]=rs.getString(5);
            eventDate[i]=rs.getDate(4);
            i++;
        }
...
"            <li class=\"active\"><a href=\"EventServlet\">Events</a></li>\n" +
...
"        <div class=\"row\">\n" +
"          <div class=\"col-md-10\">\n" +
"            <h1><span class=\"glyphicon glyphicon-cog\" aria-hidden=\"true\"></span> Event<small>  Manage Site Events</small></h1>\n" +
"          </div>\n" +
"          <div class=\"col-md-2\">\n" +
...
"                <div class=\"row\">\n" +
"                      <div class=\"col-md-12\">\n" +
"                          <input class=\"form-control\" type=\"text\" placeholder=\"Filter Events...\">\n" +
"                      </div>\n" +
"                </div>\n" +
"                <br>\n" +
...
"                      </tr>");
        ...
        while(i<count)
        {
            out.println("<tr><td class=\"body-item mbr-fonts-style display-7\">"+eventTitle[i]+"</td><td class=\"body-item mbr-fonts-style display-7\">"+eventDescription[i]+"</td><td class=\"body-item mbr-fonts-style display-7\">"+eventLink[i]+"</td><td class=\"body-item mbr-fonts-style display-7\">"+eventDate[i]+"</td><td><a class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#EditEvent\">Edit</a> <a class=\"btn btn-danger\" href=\"#\">Delete</a></td></tr>");
            i++;
        }
        out.println("                    </table>\n" +
"              </div>\n" +
