...
<html lang="az">
    ...
    <!-- Mirrored from mobirise.com/bootstrap-template/registration-form-template.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Mar 2018 12:45:54 GMT -->
    <head>
    ...
    <body >
        <section class="menu cid-qv1frvgcz3" once="menu" id="menu1-4r" data-rv-view="10798">
            ...
            <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4" href="Register.jsp">SIGN UP</a></div>
                </div>
            </nav>
        </section>
                ...
                <div class="row justify-content-center">
                    <div class="media-container-column col-lg-8">
                        ...
                        <form class="mbr-form" action="Signin" method="post">
                            ...
                            <div class="row row-sm-offset">
                                <div class="col-md-4 multi-horizontal" data-for="name">
                                    <div class="form-group">
                                        <label class="form-control-label mbr-fonts-style display-7">User Name*</label>
                                        <input type="text" class="form-control" name="uname" data-form-field="Name" required="" id="name-form1-73"/>
                                    </div>
                                </div></div>
                            ...
                            <span class="input-group-btn"><input type="submit" value = "SIGN IN" class="btn btn-primary btn-form display-4"/>SIGN IN</span>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            (function () {
                ...
                s1.async = true;
                s1.src = 'https://embed.tawk.to/5aaf7fb4d7591465c708af36/default';
                s1.charset = 'UTF-8';
    ...
    <!-- Mirrored from mobirise.com/bootstrap-template/registration-form-template.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Mar 2018 12:45:57 GMT -->
</html>