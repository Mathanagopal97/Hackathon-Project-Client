 ...
 * @author Mathan
 */
public class SwachhIdeas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            //For count
            String sql = "SELECT COUNT(*) AS COUNT FROM idea_table WHERE Submitter_Id ='ORG5'";
            ...
            sql = "SELECT * FROM idea_table WHERE Submitter_Id ='ORG5'";
            i = 0;
            rs = stmt.executeQuery(sql);
