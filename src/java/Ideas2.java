 ...
 * @author Mathan
 */
public class Ideas2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<body>\n"
                ...
                + "            </div>"
                + "<div class=\"navbar-buttons mbr-section-btn\">\n" +
"                        <a class=\"btn btn-sm btn-primary display-4\" href=\"UserSubmitIdeas.jsp\">\n" +
...
"                    </div>\n"
        ...
        out.println("<section class=\"engine\"><a href=\"#\">open source web page maker</a></section><section class=\"section-table cid-qMrek0Bwo1\" id=\"table1-1\">\n"
                ...
                + "            All the ideas from around the website are dispalyed here.<br>Click On the Idea Id to submit a proposal.     \n"
                + "      </h3>\n"
