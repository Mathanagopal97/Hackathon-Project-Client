 ...
 * @author Mathan
 */
public class ISAIdeas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            //For count
            String sql = "SELECT COUNT(*) AS COUNT FROM idea_table WHERE Submitter_Id ='ORG8'";
            ...
            sql = "SELECT * FROM idea_table WHERE Submitter_Id ='ORG8'";
            i = 0;
            rs = stmt.executeQuery(sql);
...
"                    </div>\n"
        ...
        out.println("<section class=\"engine\"><a href=\"#\">open source web page maker</a></section><section class=\"section-table cid-qMrek0Bwo1\" id=\"table1-1\">\n"
                ...
                + "            All the ideas from the ISA are dispalyed here.<br>Click On the Idea Id to submit a proposal.     \n"
                + "      </h3>\n"
