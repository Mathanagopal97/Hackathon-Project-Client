 ...
 * @author Mathan
 */
public class DigitalIndiaIdeas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            //For count
            String sql = "SELECT COUNT(*) AS COUNT FROM idea_table WHERE Submitter_Id ='ORG7'";
            ...
            sql = "SELECT * FROM idea_table WHERE Submitter_Id ='ORG7'";
            i = 0;
            rs = stmt.executeQuery(sql);
...
"                    </div>\n"
        ...
        out.println("<section class=\"engine\"><a href=\"#\">open source web page maker</a></section><section class=\"section-table cid-qMrek0Bwo1\" id=\"table1-1\">\n"
                ...
                + "         Swachh Bharath Ideas\n"
                + "      </h2>\n"
                + "      <h3 class=\"mbr-section-subtitle mbr-fonts-style align-center pb-5 mbr-light display-5\">\n"
                + "            All the ideas from the Swachh Bharath are dispalyed here.<br>Click On the Idea Id to submit a proposal.     \n"
                + "      </h3>\n"
